...
function update_config(){
    ...
    document.getElementById("what").innerHTML = (
        `Learning the <span class="var">${operation}</span> `
        + `from <span class="var">${table_min}</span> `
        + `to <span class="var">${table_max}</span> `
        + `with level <span class="var">${level}</span>.`
    )
}
